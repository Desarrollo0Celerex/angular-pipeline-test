var StatsLeadsPlugin = function() {
    ...
    function drawChartContactSourcesQuotations(chartData) {
        ...
        function drawChart(chartData) {
            ...
            var chart = new google.charts.Bar(document.getElementById('agt-stats-leads-contact-sources-quotations'));
            chart.draw(data, options);
        }
    }

    function removeChartContactSourcesQuotations() {
        document.getElementById('agt-stats-leads-contact-sources-quotations').innerHTML = '';
    }
    ...
    return {
        ...
        drawChartContactSourcesQuotations,
        removeChartContactSourcesQuotations,
    }
}();
