var StatsSinistersPlugin = function() {
    ...
    function drawChartSinisters(chartData) {
        ...
        function drawChart(chartData) {
            ...
            var chart = new google.visualization.AreaChart(document.getElementById('agt-chart-sinisters'));
            chart.draw(data, options);
        }
    }

    function removeChartSinisters() {
        document.getElementById('agt-chart-sinisters').innerHTML = '';
    }

    return {
        drawChartSinisters,
        removeChartSinisters,
    }
}();
