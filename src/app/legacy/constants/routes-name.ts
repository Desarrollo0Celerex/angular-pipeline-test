...
const EXPRESS_ROUTES = {
    expressContact: (expressToken: string) =>
        `express/express-contact/${expressToken}`,
};
...
const HOME_CONTACTS_ROUTES = {
    createContact: (contactTypeId: string) =>
        `workspace/contacts/create-contact/${contactTypeId}`,
    changeContact: (
        contactId: string,
        policyId: string,
        ...
        `workspace/contacts/change-contact/${contactId}/${policyId}/${contactTypeId}/${actionType}`,
...
const HOME_CONTACT_FILES_ROUTES = {
    uploadContactFile: (contactId: string) =>
        `workspace/files/upload-contact-file/${contactId}`,
    updateContactFile: (contactId: string, contactFileId: string) =>
        `workspace/files/update-contact-file/${contactId}/${contactFileId}`,
};

const HOME_CONTACT_PROFILE_ROUTES = {
    contactResume: (contactId: string) =>
        `workspace/contact-profile/${contactId}/resume`,
    listContactQuotations: (contactId: string) =>
        `workspace/contact-profile/${contactId}/list-quotations`,
    listContactPolicies: (contactId: string) =>
        `workspace/contact-profile/${contactId}/list-policies`,
    listContactSinisters: (contactId: string) =>
        `workspace/contact-profile/${contactId}/list-sinisters`,
    showContactData: (contactId: string) =>
        `workspace/contact-profile/${contactId}/show-contact-data`,
    listContactFiles: (contactId: string) =>
        `workspace/contact-profile/${contactId}/list-files`,
};
...
const HOME_EXTERNAL_POLICIES_ROUTES = {
    updateExternalPolicy: (contactId: string, externalPolicyId: string) =>
        `workspace/external-policies/update-external-policy/${contactId}/${externalPolicyId}`,
...
const HOME_GROUP_PROFILE_ROUTES = {
    groupResume: (groupId: string) =>
        `workspace/group-profile/${groupId}/resume`,
    groupMembers: (groupId: string) =>
        `workspace/group-profile/${groupId}/members`,
    groupPolicies: (groupId: string) =>
        `workspace/group-profile/${groupId}/policies`,
    groupSinisters: (groupId: string) =>
        `workspace/group-profile/${groupId}/sinisters`,
};
...
const HOME_PARTNER_PROFILE_ROUTES = {
    partnerResume: (partnerId: string) =>
        `workspace/partner-profile/${partnerId}/resume`,
    partnerClients: (partnerId: string) =>
        `workspace/partner-profile/${partnerId}/clients`,
    partnerPolicies: (partnerId: string) =>
        `workspace/partner-profile/${partnerId}/policies`,
    partnerSinisters: (partnerId: string) =>
        `workspace/partner-profile/${partnerId}/sinisters`,
};

const HOME_PAYMENTS_ROUTES = {
    listPayments: `workspace/payments/list-payments`,
    paymentHistory: (contactId: string, policyId: string, paymentId: string) =>
        `workspace/payments/payment-history/${contactId}/${policyId}/${paymentId}`,
    pendingReceipts: (contactId: string, policyId: string, paymentId: string) =>
    ...
    contactPendingPaymentsByRange: (
        contactId: string,
        rangeStart: string,
        rangeEnd: string
    ) =>
        `workspace/payments/contact-pending-payments-by-range/${contactId}/${rangeStart}/${rangeEnd}`,
    contactReceiptsAppliedByRange: (
        contactId: string,
        rangeStart: string,
        rangeEnd: string
    ) =>
        `workspace/payments/contact-receipts-applied-by-range/${contactId}/${rangeStart}/${rangeEnd}`,
    partnerReceiptsPendingByRange: (
        partnerId: string,
        rangeStart: string,
        rangeEnd: string
    ) =>
        `workspace/payments/partner-pending-payments-by-range/${partnerId}/${rangeStart}/${rangeEnd}`,
...
const HOME_POLICIES_ROUTES = {
    createPolicy: (contactId: string) =>
        `workspace/policies/create-policy/${contactId}`,
    uploadPolicy: (contactId: string, policyId: string) =>
        `workspace/policies/upload-policy/${contactId}/${policyId}`,
    ...
    showPolicySinisters: (contactId: string, policyId: string) =>
    ...
    updateCompletePolicy: (contactId: string, policyId: string) =>
        `workspace/policies/update-complete-policy/${contactId}/${policyId}`,
    policyTracker: (contactId: string, policyId: string) =>
        `workspace/policies/policy-tracker/${contactId}/${policyId}`,
    ...
    renewalsWithRanges: (rangeStart: string, rangeEnd: string) =>
        `workspace/policies/renewals/${rangeStart}/${rangeEnd}`,
    contactPendingRenewalsByRange: (
        contactId: string,
        rangeStart: string,
        rangeEnd: string
    ) =>
        `workspace/policies/contact-pending-renewals-by-range/${contactId}/${rangeStart}/${rangeEnd}`,
    contactAppliedRenewalsByRange: (
        contactId: string,
        rangeStart: string,
        rangeEnd: string
    ) =>
        `workspace/policies/contact-applied-renewals-by-range/${contactId}/${rangeStart}/${rangeEnd}`,
    listPolicyInsureds: (contactId: string, policyId: string) =>
        `workspace/policy-insureds/list-policy-insureds/${contactId}/${policyId}`,
    updatePolicyInsured: (
        contactId: string,
        policyId: string,
        policyInsuredId: string
    ) =>
        `workspace/policy-insureds/update-policy-insured/${contactId}/${policyId}/${policyInsuredId}`,
    createPolicyInsured: (contactId: string, policyId: string) =>
        `workspace/policy-insureds/create-policy-insured/${contactId}/${policyId}`,
    importPolicyInsureds: (contactId: string, policyId: string) =>
        `workspace/policy-insureds/import-policy-insureds/${contactId}/${policyId}`,
...
const HOME_POLICY_ENDORSEMENTS_ROUTES = {
    ...
    policyEndorsementsHistory: (contactId: string, policyId: string) =>
        `workspace/policies/endorsements/history/${contactId}/${policyId}`,
};

const HOME_QUOTATIONS_ROUTES = {
    createQuotation: (contactId: string) =>
        `workspace/quotations/create-quotation/${contactId}`,
...
const HOME_RENEWALS_ROUTES = {
    policyRenewalHistory: (contactId: string, policyId: string) =>
        `workspace/renewals/policy-renewal-history/${contactId}/${policyId}`,
    policyRenewalsApplied: (contactId: string, policyId: string) =>
...
const HOME_SINISTERS_ROUTES = {
    ...
    showSinisterHistory: (
        ...
        `workspace/sinisters/sinister-history/${contactId}/${policyId}/${sinisterId}`,
    showPolicyOpenSinisters: (contactId: string, policyId: string) =>
        `workspace/sinisters/policy-open-sinisters/${contactId}/${policyId}`,
    showPolicyClosedSinisters: (contactId: string, policyId: string) =>
    ...
    finalizeSinister: (
        ...
        `workspace/sinisters/finalize-sinister/${contactId}/${policyId}/${sinisterId}`,
    reactivateSinister: (
        contactId: string,
        policyId: string,
        sinisterId: string
    ) =>
        `workspace/sinisters/reactivate-sinister/${contactId}/${policyId}/${sinisterId}`,
...
const HOME_WALLET_ROUTES = {
    ...
    walletIdentity: (walletId: string) =>
        `workspace/wallet/identity/${walletId}`,
...
const INVITATIONS_ROUTES = {
    checkAcceptInvitation: (invitationToken: string) =>
        `invitations/check-accept-invitation/${invitationToken}`,
