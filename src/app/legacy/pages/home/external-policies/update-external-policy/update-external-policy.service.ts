...
export class UpdateExternalPolicyService {
    ...
    buildForm(externalPolicy: ExternalPolicy): void {
        this.form = this._formBuilder.group({
            coveredProperty: [
                !!externalPolicy && !!externalPolicy.coveredProperty
                    ? externalPolicy.coveredProperty
                    : '',
                [
                    Validators.required,
            ...
            policyNumber: [
                !!externalPolicy && !!externalPolicy.policyNumber
                    ? externalPolicy.policyNumber
                    : '',
                [
                    Validators.required,
                    Validators.minLength(FREE_TEXT_LENGTH.MIN),
            ...
            clientNumber: [
                !!externalPolicy && !!externalPolicy.clientNumber
                    ? externalPolicy.clientNumber
                    : '',
                [
                    Validators.minLength(FREE_TEXT_LENGTH.MIN),
                    Validators.maxLength(FREE_TEXT_LENGTH.MAX),
            ...
            insurerId: [
                !!externalPolicy && !!externalPolicy.insurerId
                    ? externalPolicy.insurerId
                    : '',
                [Validators.required],
            ],
            insuranceId: [
                !!externalPolicy && !!externalPolicy.insuranceId
                    ? externalPolicy.insuranceId
                    : '',
                [Validators.required],
            ],
            insuranceTypeId: [
                !!externalPolicy && !!externalPolicy.insuranceTypeId
                    ? externalPolicy.insuranceTypeId
                    : '',
                [Validators.required],
            ],
            titularName: [
                !!externalPolicy && !!externalPolicy.titularName
                    ? externalPolicy.titularName
                    : '',
                [
                    Validators.required,
            ...
            titularRfc: [
                !!externalPolicy && !!externalPolicy.titularRfc
                    ? externalPolicy.titularRfc
                    : '',
                [
                    Validators.minLength(FREE_TEXT_LENGTH.MIN),
                    Validators.maxLength(FREE_TEXT_LENGTH.MAX),
            ...
            titularPostalCode: [
                !!externalPolicy && !!externalPolicy.titularPostalCode
                    ? externalPolicy.titularPostalCode
                    : '',
                [ValidatorsHelper.postalCode],
            ],
            titularPhoneNumber: [
                !!externalPolicy && !!externalPolicy.titularPhoneNumber
                    ? externalPolicy.titularPhoneNumber
                    : '',
                [ValidatorsHelper.phoneNumber],
            ],
            emissionDate: [
                !!externalPolicy && !!externalPolicy.emissionDate
                    ? moment(externalPolicy.emissionDate).format('DD/MM/YYYY')
                    : '',
                [Validators.required, ValidatorsHelper.date],
            ],
            validityStartDate: [
                !!externalPolicy && !!externalPolicy.validityStartDate
                    ? moment(externalPolicy.validityStartDate).format(
                          'DD/MM/YYYY'
                      )
                    : '',
                [Validators.required, ValidatorsHelper.date],
            ...
            validityEndDate: [
                !!externalPolicy && !!externalPolicy.validityEndDate
                    ? moment(externalPolicy.validityEndDate).format(
                          'DD/MM/YYYY'
                      )
                    : '',
                [Validators.required, ValidatorsHelper.date],
            ...
            netPay: [
                !!externalPolicy && !!externalPolicy.netPay
                    ? externalPolicy.netPay
                    : '',
                [Validators.required, ValidatorsHelper.amount],
            ],
            taxPay: [
                !!externalPolicy && !!externalPolicy.taxPay
                    ? externalPolicy.taxPay
                    : '',
                [Validators.required, ValidatorsHelper.amount],
            ],
            feePay: [
                !!externalPolicy && !!externalPolicy.feePay
                    ? externalPolicy.feePay
                    : '',
                [Validators.required, ValidatorsHelper.amount],
            ],
            coverPay: [
                !!externalPolicy && !!externalPolicy.coverPay
                    ? externalPolicy.coverPay
                    : '',
                [Validators.required, ValidatorsHelper.amount],
            ],
            extraPay: [
            ...
            policyAmount: [
                !!externalPolicy && !!externalPolicy.policyAmount
                    ? externalPolicy.policyAmount
                    : '',
                [Validators.required, ValidatorsHelper.amount],
            ],
            currencyId: [
                !!externalPolicy && !!externalPolicy.currencyId
                    ? externalPolicy.currencyId
                    : '',
                [Validators.required],
            ],
            paymentMethodId: [
                !!externalPolicy && !!externalPolicy.paymentMethodId
                    ? externalPolicy.paymentMethodId
                    : '',
                [Validators.required],
            ],
            paymentPlanId: [
                !!externalPolicy && !!externalPolicy.paymentPlanId
                    ? externalPolicy.paymentPlanId
                    : '',
                [Validators.required],
            ],
        });
    ...
    updateExternalPolicy(
        ...
        const requestBody: UpdateExternalPolicyDataSend =
            this._getRequestBody();
        return this._externalPolicyService.updateExternalPolicy(
            contactId,
            externalPolicyId,
            requestBody
        );
