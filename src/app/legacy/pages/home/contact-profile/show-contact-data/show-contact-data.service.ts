...
export class ShowContactDataService {
        ...
        if (this.contact !== null) {
            this.contactForm = this._formBuilder.group({
                ...
                street: [
                    this.contact.street || '',
                    [
                        Validators.minLength(FREE_TEXT_LENGTH),
                        Validators.maxLength(FREE_TEXT_LENGTH),
                        ValidatorsHelper.freeText,
                    ],
                ],
                exteriorNumber: [
                    this.contact.exteriorNumber || '',
                    [
            ...
            if (
                ...
                this.contact.contactTypeId == CONTACT_TYPES.PERSON
            ) {
                this.contactForm.addControl(
                    'name',
                    new FormControl(this.contact.name || '', [
                        Validators.required,
                ...
                this.contactForm.addControl(
                    'namePaternal',
                    new FormControl(this.contact.namePaternal || '', [
                        Validators.required,
                        Validators.minLength(OWN_NAME_LENGTH.MIN),
                        Validators.maxLength(OWN_NAME_LENGTH.MAX),
                        ValidatorsHelper.ownName,
                ...
                this.contactForm.addControl(
                    'nameMaternal',
                    new FormControl(this.contact.nameMaternal || '', [
                        Validators.minLength(OWN_NAME_LENGTH.MIN),
                        Validators.maxLength(OWN_NAME_LENGTH.MAX),
                        ValidatorsHelper.ownName,
                    ])
                ...
                this.contactForm.addControl(
                    'genderId',
                    new FormControl(this.contact.genderId || '', [
                        Validators.required,
                ...
                this.contactForm.addControl(
                    'birthdate',
                    new FormControl(
                        this._getDateFormat(this.contact.birthdate) || '',
                        [ValidatorsHelper.date]
                    )
                );
                this.contactForm.addControl(
                    'civilStatusId',
                    new FormControl(this.contact.civilStatusId || '', [
                        ValidatorsHelper.number,
                    ])
                );
                this.contactForm.addControl(
                    'offspringId',
                    new FormControl(this.contact.offspringId || '', [
                        ValidatorsHelper.number,
                    ])
                );
                this.contactForm.addControl(
                    'contactStudyId',
                    new FormControl(this.contact.contactStudyId || '', [
                        ValidatorsHelper.number,
                    ])
                );
                this.contactForm.addControl(
                    'contactOccupationId',
                    new FormControl(this.contact.contactOccupationId || '', [
                        ValidatorsHelper.number,
                    ])
                );
                this.contactForm.addControl(
                    'contactJobId',
                    new FormControl(this.contact.contactJobId || '', [
                        ValidatorsHelper.number,
                    ])
                );
                this.contactForm.addControl(
                    'contactHomeId',
                    new FormControl(this.contact.contactHomeId || '', [
                        ValidatorsHelper.number,
                    ])
                );
                this.contactForm.addControl(
                    'contactCarId',
                    new FormControl(this.contact.contactCarId || '', [
                        ValidatorsHelper.number,
                    ])
                );
                this.contactForm.addControl(
                    'contactSmartphoneId',
                    new FormControl(this.contact.contactSmartphoneId || '', [
                        ValidatorsHelper.number,
                    ])
                );
            } else {
                this.contactForm.addControl(
                    'companyName',
                    new FormControl(this.contact.companyName || '', [
                        Validators.required,
                ...
                this.contactForm.addControl(
                    'brandName',
                    new FormControl(this.contact.brandName || '', [
                        Validators.required,
                        Validators.minLength(BRAND_NAME_LENGTH.MIN),
                        Validators.maxLength(BRAND_NAME_LENGTH.MAX),
                        ValidatorsHelper.brandName,
    ...
    loadCivilStatus(): void {
        ...
        this._civilStatusService
            .getCivilStatus(fields)
    ...
    loadContactStudies(): void {
        ...
        this._contactCatalogService
            .getContactStudies(fields)
            .subscribe((res: HttpResponse) => {
    ...
    loadContactInformations(contactId: string): void {
        const fields: string =
            'contactInformationId,email,phoneCodeId,phoneNumber,responsibleName,mainContactTypeId,contactInformationTypeId';
        this._contactInformationService
            .getContactInformations(contactId, fields)
            .subscribe((res: HttpResponse) => {
    ...
    loadContactOccupations(): void {
        ...
        this._contactOccupationService
            .getContactOccupations(fields)
            .subscribe((res: HttpResponse) => {
    ...
    loadOffsprings(): void {
        ...
        this._offspringService
            .getOffsprings(fields)
            .subscribe((res: HttpResponse) => {
    ...
    updateContact(contactId: string): Observable<void> {
        const requestBody: UpdateContactDataSend = {
            ...this.contactForm.value,
        };
        return this._contactService.updateContact(contactId, requestBody);
    }

    private _buildFormContactInformations(
        contactInformations: ContactInformation[]
    ): void {
        this._addMainContacts(contactInformations);
        const issuesContact: ContactInformation | null =
            this._findContactInformation(
                CONTACT_INFORMATION_TYPES.ISSUES,
                contactInformations
            );
        const paymentsContact: ContactInformation | null =
            this._findContactInformation(
                CONTACT_INFORMATION_TYPES.PAYMENTS,
                contactInformations
            );
        const sinistersContact: ContactInformation | null =
            this._findContactInformation(
                CONTACT_INFORMATION_TYPES.SINISTERS,
                contactInformations
            );
        this._addContactInformation(
            issuesContact,
            CONTACT_INFORMATION_TYPES.ISSUES
        );
        this._addContactInformation(
    ...
    private _addMainContacts(contactInformations: ContactInformation[]): void {
        for (let contactInformation of contactInformations) {
            if (
                contactInformation.contactInformationTypeId ===
                CONTACT_INFORMATION_TYPES.MAIN
            ) {
                this._addContactInformation(
                    contactInformation,
                    CONTACT_INFORMATION_TYPES.MAIN
    ...
    private _addContactInformation(
        contactInformation: ContactInformation | null = null,
        contactInformationTypeId: number
    ): void {
        this.contactInformations.push(
            this._newContactInformation(
                contactInformation,
    ...
    private _findContactInformation(
        key: number,
        data: ContactInformation[]
    ): ContactInformation | null {
        const contactInformation: ContactInformation | undefined = data.find(
            (element: ContactInformation) =>
                element.contactInformationTypeId === key
        );
    ...
    private _newContactInformation(
        contactInformation: ContactInformation | null = null,
        contactInformationTypeId: number
    ): FormGroup {
        return this._formBuilder.group({
            ...
            email: [
                contactInformation !== null && contactInformation.email
            ...
            phoneCodeId: [
                contactInformation !== null && contactInformation.phoneCodeId
                    ? contactInformation.phoneCodeId
                    : this.contact!.workspaceCountryId,
                [ValidatorsHelper.number],
            ],
            phoneNumber: [
                contactInformation !== null && contactInformation.phoneNumber
            ...
            responsibleName: [
                contactInformation !== null &&
                contactInformation.responsibleName
                    ? contactInformation.responsibleName
                    : '',
                [
                    Validators.minLength(OWN_NAME_LENGTH.MIN),
            ...
            mainContactTypeId: [
                contactInformation !== null &&
                contactInformation.mainContactTypeId
                    ? contactInformation.mainContactTypeId
                    : '',
                [ValidatorsHelper.number],
            ],
