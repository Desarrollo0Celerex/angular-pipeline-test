...
export class ReactivateSinisterService {
    ...
    loadSinisterReactivations(): void {
        ...
        this._sinisterReactivationService
            .getSinisterReactivations(fields)
    ...
    reactivateSinister(sinisterData: SinisterDataSend): Observable<void> {
        ...
        return this._sinisterService.reactivateSinister(
            sinisterData.contactId,
            sinisterData.policyId,
            sinisterData.sinisterId,
            requestBody
    ...
    private _getRequestBody(): FormData {
        ...
        requestBody.append(
            'sinisterReactivationId',
            this.f.sinisterReactivationId.value
        );
