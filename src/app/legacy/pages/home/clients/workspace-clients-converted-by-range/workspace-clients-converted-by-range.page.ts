...
@Component({
    selector: 'agt-workspace-clients-converted-by-range',
    templateUrl: './workspace-clients-converted-by-range.page.html',
    styles: [],
    standalone: false
})
export class WorkspaceClientsConvertedByRangePage implements OnInit {
