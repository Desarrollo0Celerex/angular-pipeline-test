...
@Component({
    selector: 'agt-contact-pending-renewals-by-range',
    templateUrl: './contact-pending-renewals-by-range.page.html',
    styles: [],
    standalone: false
})
export class ContactPendingRenewalsByRangePage implements OnInit {
