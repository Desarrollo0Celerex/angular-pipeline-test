...
export class ResumeService {
    ...
    loadWorkspace(): void {
        ...
        this._workspaceService.getWorkspace(fields).subscribe((res: HttpResponse) => {
            ...
            this.isCompletedCardium = (workspace.cardiumUrl !== null) ? true : false;
            this.isCompletedFacebook = (workspace.facebookUrl !== null) ? true : false;
            this.isCompletedInstagram = (workspace.instagramUrl !== null) ? true : false;
            this.isCompletedTwitter = (workspace.twitterUrl !== null) ? true : false;
            this.isCompletedLinkedin = (workspace.linkedinUrl !== null) ? true : false;
            this.isCompletedTiktok = (workspace.tiktokUrl !== null) ? true : false;
