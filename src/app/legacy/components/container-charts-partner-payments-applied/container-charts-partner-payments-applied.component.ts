...
import { ContainerChartsPartnerPaymentsAppliedService } from './container-charts-partner-payments-applied.service';

declare var ModalPlugin: any;

@Component({
    selector: 'agt-container-charts-partner-payments-applied',
...
export class ContainerChartsPartnerPaymentsAppliedComponent {
    ...
    constructor(public model: ContainerChartsPartnerPaymentsAppliedService) {}
