...
@NgModule({
    declarations: [ContainerInsurancesBySubcategoryComponent],
    exports: [ContainerInsurancesBySubcategoryComponent],
    imports: [CardInsuranceModule, CommonModule, LoadingContentModule],
    providers: [ContactService, InsuranceService, InsuranceSubcategoryService],
})
