...
@NgModule({
    declarations: [ContainerClientRetentionKpisComponent],
    exports: [ContainerClientRetentionKpisComponent],
    imports: [CommonModule, CardKpiOneModule],
    providers: [ClientService, WorkspaceService],
})
