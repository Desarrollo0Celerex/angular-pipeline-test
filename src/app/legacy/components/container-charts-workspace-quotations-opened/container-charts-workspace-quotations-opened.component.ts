...
import { ContainerChartsWorkspaceQuotationsOpenedService } from './container-charts-workspace-quotations-opened.service';
...
@Component({
  ...
  providers: [
    ContainerChartsWorkspaceQuotationsOpenedService
  ]
})
export class ContainerChartsWorkspaceQuotationsOpenedComponent implements OnChanges {
    ...
    constructor(public model: ContainerChartsWorkspaceQuotationsOpenedService) { }
