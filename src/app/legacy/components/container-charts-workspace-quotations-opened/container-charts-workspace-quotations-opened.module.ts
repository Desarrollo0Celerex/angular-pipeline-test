...
import { ContainerChartsWorkspaceQuotationsOpenedComponent } from './container-charts-workspace-quotations-opened.component';

@NgModule({
  declarations: [
    ContainerChartsWorkspaceQuotationsOpenedComponent
  ],
  exports: [
    ContainerChartsWorkspaceQuotationsOpenedComponent
  ],
...
export class ContainerChartsWorkspaceQuotationsOpenedModule { }
