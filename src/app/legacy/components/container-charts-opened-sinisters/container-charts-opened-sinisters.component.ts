...
import { ContainerChartsOpenedSinistersService } from './container-charts-opened-sinisters.service';

declare var ModalPlugin: any;

@Component({
    selector: 'agt-container-charts-opened-sinisters',
...
export class ContainerChartsOpenedSinistersComponent implements OnChanges {
    ...
    constructor(public model: ContainerChartsOpenedSinistersService) {}
