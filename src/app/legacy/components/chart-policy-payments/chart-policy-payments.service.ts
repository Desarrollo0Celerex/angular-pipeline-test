...
export class ChartPolicyPaymentsService {
    ...
    loadPolicyPaymentStatistics(contactId: string, policyId: string): Observable<void> {
        return this._statisticService.getPolicyPaymentStatistics(contactId, policyId).pipe(
