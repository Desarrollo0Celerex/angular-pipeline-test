...
import { ContainerChartsExternalPoliciesService } from './container-charts-external-policies.service';

declare var ModalPlugin: any;

@Component({
    selector: 'agt-container-charts-external-policies',
...
export class ContainerChartsExternalPoliciesComponent implements OnInit {
    ...
    constructor(public model: ContainerChartsExternalPoliciesService) {}
