...
export class ContainerPaymentsManagerComponent implements OnInit {
    ...
    modalIdConfirmSuspendPayments: string =
        'cpm-modal-confirm-suspend-payments';
    modalIdConfirmActivatePayments: string =
        'cpm-modal-confirm-activate-payments';
    modalIdConfirmShowPendingReceipts: string =
        'cpm-modal-confirm-show-pending-payments';
    modalIdConfirmShowReceiptsPaid: string =
        'cpm-modal-confirm-show-payments-paid';
    modalIdConfirmShowPaymentHistory: string =
        'cpm-modal-confirm-show-payment-history';
    ...
    suspendPayments(): void {
        if (!!this.model.payment) {
            ...
            this.model
                .updatePolicyStatus(
                    this.model.payment.policyId,
                    POLICY_STATUS.SUSPENDED
                )
                .subscribe(() => {
                    if (!!this.model.payment) {
                        this.model.payment.policyStatusId =
                            POLICY_STATUS.SUSPENDED;
                    }
