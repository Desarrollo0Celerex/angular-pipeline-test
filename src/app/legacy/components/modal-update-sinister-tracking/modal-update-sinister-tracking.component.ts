...
export class ModalUpdateSinisterTrackingComponent implements OnInit {
    ...
    updateSinisterTracking(): void {
        ...
        if(this.model.form.valid && !!this.sinisterData) {
            ...
            this.model.updateSinisterTracking(this.sinisterData).subscribe(() => {
    ...
    private _initCalendars(): void {
        ...
        DatePickerPlugin.initElement(this.calendarIdNotificationDate, this._onChangeDate, this);
    ...
    private _onChangeDate(selectorId: string, changedValue: string, context: ModalUpdateSinisterTrackingComponent): void {
