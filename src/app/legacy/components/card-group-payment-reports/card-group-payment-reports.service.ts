...
export class CardGroupPaymentReportsService {
    ...
    private _generatePaymentRequests(
        ...
        const requestTotalGroupAppliedPayments: Observable<number> =
            this._receiptPaidService.getTotalGroupReceiptsPaid(
                groupId,
                rangeField,
                rangeStart,
                rangeEnd
            );
        const requestTotalGroupPendingPayments: Observable<number> =
            this._paymentService.getTotalGroupPayments(
                groupId,
                filters,
                rangeField,
                rangeStart,
