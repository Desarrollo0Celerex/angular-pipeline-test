...
import { ContainerChartsReceiptsAppliedService } from './container-charts-receipts-applied.service';

declare var ModalPlugin: any;

@Component({
    selector: 'agt-container-charts-receipts-applied',
...
export class ContainerChartsReceiptsAppliedComponent implements OnChanges {
    ...
    constructor(public model: ContainerChartsReceiptsAppliedService) {}
