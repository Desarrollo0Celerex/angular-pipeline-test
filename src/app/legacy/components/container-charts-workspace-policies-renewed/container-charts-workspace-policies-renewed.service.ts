...
@Injectable()
export class ContainerChartsWorkspacePoliciesRenewedService {
    ...
    loadData(rangeField: string, rangeStart: string, rangeEnd: string): void {
        ...
        this._policyService.getWorkspacePoliciesRenewedSmartInsights(filters, rangeField, rangeStart, rangeEnd, this.specialFilter).subscribe((res: ContainerCharts) => {
            this.chartsData = res;
