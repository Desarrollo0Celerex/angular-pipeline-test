...
import { ContainerChartsIncompletePoliciesService } from './container-charts-incomplete-policies.service';

declare var ModalPlugin: any;

@Component({
    selector: 'agt-container-charts-incomplete-policies',
...
export class ContainerChartsIncompletePoliciesComponent implements OnInit {
    ...
    constructor(public model: ContainerChartsIncompletePoliciesService) {}
