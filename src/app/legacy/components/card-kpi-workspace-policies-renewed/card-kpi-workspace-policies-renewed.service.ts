...
export class CardKpiWorkspacePoliciesRenewedService {
    ...
    loadTotalWorkspaceRenewals(range: RangeData): void {
        ...
        this._policyService.getTotalWorkspaceRenewals(filters, rangeField, range.rangeStart, range.rangeEnd).subscribe((res: number) => {
    ...
    loadTotalWorkspacePoliciesRenewed(range: RangeData): void {
        ...
        this._policyService.getTotalWorkspacePoliciesRenewed(filters, rangeField, range.rangeStart, range.rangeEnd).subscribe((res: number) => {
