...
import { ContainerChartsWorkspacePoliciesIssuedService } from './container-charts-workspace-policies-issued.service';

declare var ModalPlugin: any;

@Component({
  selector: 'agt-container-charts-workspace-policies-issued',
  templateUrl: './container-charts-workspace-policies-issued.component.html',
  styles: [
  ],
  providers: [ContainerChartsWorkspacePoliciesIssuedService]
})
export class ContainerChartsWorkspacePoliciesIssuedComponent implements OnChanges {
    ...
    constructor(public model: ContainerChartsWorkspacePoliciesIssuedService) { }
