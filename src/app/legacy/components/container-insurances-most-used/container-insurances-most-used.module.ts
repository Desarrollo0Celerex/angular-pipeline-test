...
@NgModule({
    declarations: [ContainerInsurancesMostUsedComponent],
    exports: [ContainerInsurancesMostUsedComponent],
    imports: [CardInsuranceModule, CommonModule, ImageAgenthosAssistantModule],
    providers: [ContactService, InsuranceService],
})
