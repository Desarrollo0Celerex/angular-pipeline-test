...
export class ChartCancelledPoliciesService {
    ...
    getCancelledPoliciesStats(
        ...
        requests.push(
            this._policyService.getCancelledPoliciesStats(
                filters,
                rangeField,
    ...
    loadCancelledPoliciesStatsData(
        cancelledPoliciesStats: StatRangeData[][]
    ): void {
        const headerData: any[] = [
            ['Pólizas', 'Periodo Seleccionado', 'Periodo Comparación'],
        ];
        this.cancelledPoliciesStatsData = ChartHelper.generateChartDataByRanges(
            cancelledPoliciesStats,
            headerData
        );
    }
}
