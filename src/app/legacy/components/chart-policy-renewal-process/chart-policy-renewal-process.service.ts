...
export class ChartPolicyRenewalProcessService {
    ...
    getRenewalProcessStats(range: ComparisonRangeData): Observable<number[]> {
        ...
        requests.push(
            this._policyService.getTotalWorkspaceRenewalsApplied(
                filters,
                rangeField,
        ...
        requests.push(
            this._policyService.getTotalWorkspaceRenewalsPending(
                filters,
                rangeField,
                range.selectedRangeStart,
                range.selectedRangeEnd
    ...
    loadRenewalProcessStatsData(renewalProcessStats: number[]): void {
        this.renewalProcessStatsData.push([
            'Estatus',
        ...
        this.renewalProcessStatsData.push([
            '',
            renewalProcessStats[0],
            renewalProcessStats[1],
            '',
        ]);
    }
}
