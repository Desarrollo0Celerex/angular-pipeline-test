...
import { ContainerChartsPartnerPaymentsPendingService } from './container-charts-partner-payments-pending.service';
...
export class ContainerChartsPartnerPaymentsPendingComponent {
    ...
    constructor(public model: ContainerChartsPartnerPaymentsPendingService) {}
    ...
    applyInsuranceFilters(filterIds: number[]): void {
        ...
        this.model.loadData(this.partnerId, this.rangeField, this.rangeStart, this.rangeEnd);
