...
export class ModalSearchClientService {
    ...
    getClients(): Observable<HttpResponse> {
        const fields: string =
            'contactId,contactName,avatarUrl,clientStatusName,clientStatusBackground,contactSourceName,contactScoreName,totalGlobalWallet,totalActivePolicies,currencyName,createdAt';
    ...
    loadGroupMembers(groupId: string): void {
        ...
        this._groupMemberService
            .getGroupMembers(groupId, fields, page, query, perPage)
