...
@Injectable()
export class CardReportRenewedPoliciesService {
    ...
    downloadReport(rangeField: string, rangeStart: string, rangeEnd: string, specialFilter: string, formatType: number): Promise<void> {
        return new Promise((resolve) => {
            ...
            this._policyService.downloadReportRenewedPolicies(filters, rangeField, rangeStart, rangeEnd, sortBy, specialFilter, formatType).then((response: any) => {
