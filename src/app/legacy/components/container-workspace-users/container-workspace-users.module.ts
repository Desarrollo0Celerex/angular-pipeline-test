...
@NgModule({
    declarations: [ContainerWorkspaceUsersComponent],
    exports: [ContainerWorkspaceUsersComponent],
    imports: [CommonModule, CardUserModule, ModalSelectRoleModule],
    providers: [WorkspaceUserService, RoleService],
})
