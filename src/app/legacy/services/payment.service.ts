...
export class PaymentService {
    ...
    downloadReportGroupPendingPayments(
        groupId: string,
        filters: string = '',
        rangeField: string = '',
        rangeStart: string = '',
        ...
        const route: string = routes.reportGroupPendingPayments(
            this._workspaceId,
            groupId
        );
        let params: HttpParams = new HttpParams();
    ...
    getPendingPaymentStats(
        ...
        const route: string = routes.workspacePendingPaymentStats(
            this._workspaceId
        );
        let params: HttpParams = new HttpParams();
        if (!!filters) params = params.append('filter', filters);
    ...
    getTotalContactPayments(
        ...
        const route: string = routes.totalContactPayments(
            this._workspaceId,
            contactId
        );
        let params: HttpParams = new HttpParams();
    ...
    getTotalGroupPayments(
        ...
        const route: string = routes.totalGroupPayments(
            this._workspaceId,
            groupId
        );
        let params: HttpParams = new HttpParams();
    ...
    getTotalPartnerPayments(
        ...
        const route: string = routes.totalPartnerPayments(
            this._workspaceId,
            partnerId
        );
        let params: HttpParams = new HttpParams();
    ...
    preauthorizePayment(paymentId: string): Observable<void> {
        const route: string = routes.paymentPreauthorizations(
            this._workspaceId,
            paymentId
        );
    ...
    updatePaymentDate(
        paymentId: string,
        requestBody: UpdatePaymentDateDataSend
    ): Observable<void> {
