...
const ROUTES = {
    policySourcesStats: (workspaceId: string) => `${environment.apiUrl}/workspaces/${workspaceId}/stats/policy-sources`,
}
...
export class PolicySourceService {
     ...
     */
    getPolicySourcesStats(filters: string = ''): Observable<PolicySourceStat[]> {
