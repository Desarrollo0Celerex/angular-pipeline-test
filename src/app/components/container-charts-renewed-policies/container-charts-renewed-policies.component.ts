...
import { ContainerChartsRenewedPoliciesService } from './container-charts-renewed-policies.service';

declare var ModalPlugin: any;

@Component({
  selector: 'agt-container-charts-renewed-policies',
  templateUrl: './container-charts-renewed-policies.component.html',
  styles: [
  ],
  providers: [
      ContainerChartsRenewedPoliciesService
  ]
})
export class ContainerChartsRenewedPoliciesComponent {
    ...
    constructor(public model: ContainerChartsRenewedPoliciesService) { }
