...
export class CardReportActivePoliciesService {
    ...
    downloadReport(rangeStart: string, rangeEnd: string, specialFilter: string): Promise<void> {
        return new Promise((resolve) => {
            this._policyService.downloadReportActivePolicies(rangeStart, rangeEnd, specialFilter).then((response: any) => {
