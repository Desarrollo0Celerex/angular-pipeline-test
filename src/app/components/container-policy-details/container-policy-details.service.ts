...
export class ContainerPolicyDetailsService {
    ...
    loadPolicy(contactId: string, policyId: string): void {
        const fields: string = 'policyId,policyStatusName,policyStatusBackground,policyStatusDescription,insuranceName,insuranceIcon,insuranceBackground,insuranceTypeName,paymentPlanName,policyNumber,currencyName,amount,coveredProperty,lifeTime,amountApplied,bills,emissionDate,validityStartDate,validityEndDate,totalEndorsements';
