...
export class ChartGeneratedClientsService {
    ...
    getClientsGeneratedStats(range: RangeData): Observable<RangeStat[][]> {
        ...
        requests.push(this._clientService.getClientsGeneratedStats(rangeField, range.selectedRangeStart, range.selectedRangeEnd));
        requests.push(this._clientService.getClientsGeneratedStats(rangeField, range.comparedRangeStart, range.comparedRangeEnd));
