...
export class ChartPolicyEndorsementsBehaviorService {
    ...
    loadPolicyEndorsementBehaviorStatistics(contactId: string, policyId: string): Observable<void> {
        return this._statisticService.getPolicyEndorsementBehaviorStatistics(contactId, policyId).pipe(
