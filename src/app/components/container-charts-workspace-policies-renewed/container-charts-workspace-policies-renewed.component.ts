...
import { ContainerChartsWorkspacePoliciesRenewedService } from './container-charts-workspace-policies-renewed.service';

declare var ModalPlugin: any;

@Component({
  selector: 'agt-container-charts-workspace-policies-renewed',
...
export class ContainerChartsWorkspacePoliciesRenewedComponent implements OnChanges {
    ...
    constructor(public model: ContainerChartsWorkspacePoliciesRenewedService) { }
