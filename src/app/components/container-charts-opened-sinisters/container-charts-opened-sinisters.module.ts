...
import { ContainerChartsOpenedSinistersComponent } from './container-charts-opened-sinisters.component';

@NgModule({
  declarations: [
    ContainerChartsOpenedSinistersComponent
  ],
  exports: [
      ContainerChartsOpenedSinistersComponent
  ],
...
export class ContainerChartsOpenedSinistersModule { }
