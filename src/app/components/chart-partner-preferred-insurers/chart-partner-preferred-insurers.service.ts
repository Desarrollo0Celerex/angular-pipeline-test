...
@Injectable()
export class ChartPartnerPreferredInsurersService {
    chartData: any[] = [];
    ...
    loadChartData(partnerId: number): Observable<void> {
        ...
        return new Observable((observer: any) => {
            ...
            this._policyService.getTotalPartnerPolicies(partnerId, filter).subscribe((res: HttpResponse) => {
                const page: number = 1;
                ...
                this._policyService.getPartnerPolicies(partnerId.toString(), page, fields, filters, '', perPage).subscribe((res: HttpResponse) => {
