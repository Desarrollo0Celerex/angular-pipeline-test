...
export class ChartPolicyEndorsementsService {
    ...
    loadPolicyEndorsementStatistics(contactId: string, policyId: string): Observable<void> {
        return this._statisticService.getPolicyEndorsementStatistics(contactId, policyId).pipe(
