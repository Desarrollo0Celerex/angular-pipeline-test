...
export class ContainerFiltersInsuranceSinistersService {
    ...
    loadData(insuranceId: number, rangeField: string, rangeStart: string, rangeEnd: string): void {
        ...
        this._sinisterService.getInsuranceSinisterFilters(insuranceId, filters, rangeField, rangeStart, rangeEnd, this.specialFilter).subscribe((res: ContainerCharts) => {
            this.chartsData = res;
