...
export class SinisterEventHelper {
    ...
    static generateSinisterEventDetails(sinisterLog: SinisterLog): string {
        ...
        sinisterLog.sinisterEventTypeId = (!!sinisterLog.sinisterEventTypeId) ? parseInt(sinisterLog.sinisterEventTypeId.toString()) : 0;
        sinisterLog.providerDate = (!!sinisterLog.providerDate) ? moment(sinisterLog.providerDate).format('DD/MM/YYYY') : '';
        sinisterLog.providerBill = (!!sinisterLog.providerBill) ? currency.format(parseFloat(sinisterLog.providerBill)) : '';
        switch(sinisterLog.sinisterEventTypeId) {
            case SINISTER_EVENT_TYPES.WORKSHOP_AND_SERVICE:
                if(!!sinisterLog.providerName) {
                    eventDetails += 'Se asigna responsable de taller con nombre: '+sinisterLog.providerName;
                }
                if(!!sinisterLog.providerDate) {
                    eventDetails += ', el día: '+sinisterLog.providerDate;
                }
                if(!!sinisterLog.providerFolio) {
                    eventDetails += ', con número de servicio: '+sinisterLog.providerFolio;
                }
            ...
            case SINISTER_EVENT_TYPES.CIVIL_WORK:
                if(!!sinisterLog.providerName) {
                    eventDetails += 'Se asigna responsable de constructora con nombre: '+sinisterLog.providerName;
                }
                if(!!sinisterLog.providerDate) {
                    eventDetails += ', el día: '+sinisterLog.providerDate;
                }
            ...
            case SINISTER_EVENT_TYPES.CRANES_AND_TRANSFER:
                if(!!sinisterLog.providerName) {
                    eventDetails += 'Se asigna servicio de grúas con nombre: '+sinisterLog.providerName;
                }
                if(!!sinisterLog.providerDate) {
                    eventDetails += ', el día: '+sinisterLog.providerDate;
                }
            ...
            case SINISTER_EVENT_TYPES.LEGAL_PROCESS:
                if(!!sinisterLog.providerName) {
                    eventDetails += 'Se asigna abogado con nombre: '+sinisterLog.providerName;
                }
                if(!!sinisterLog.providerDate) {
                    eventDetails += ', el día: '+sinisterLog.providerDate;
                }
