...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: ROUTES_NAME.listPendingPaymentsByRangeWithRanges(':rangeStart', ':rangeEnd'), loadChildren: () => import('@pages/home/payments/list-pending-payments-by-range/list-pending-payments-by-range.module').then(mod => mod.ListPendingPaymentsByRangeModule), canActivate: [UserAuthenticatedGuard, WorkspaceActivatedGuard] },
            ...
            { path: ROUTES_NAME.renewalsWithRanges(':rangeStart', ':rangeEnd'), loadChildren: () => import('@pages/home/policies/renewals/renewals.module').then( mod => mod.RenewalsModule), canActivate: [UserAuthenticatedGuard, WorkspaceActivatedGuard] },
            ...
            { path: ROUTES_NAME.cancelledPoliciesWithRanges(':rangeStart', ':rangeEnd'), loadChildren: () => import('@pages/home/policies/cancelled-policies/cancelled-policies.module').then( mod => mod.CancelledPoliciesModule), canActivate: [UserAuthenticatedGuard, WorkspaceActivatedGuard] },
