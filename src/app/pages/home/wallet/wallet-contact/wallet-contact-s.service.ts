...
export class WalletContactSService {
    ...
    buildForm(walletContact: WalletContact): void {
        this.form = this._formBuilder.group({
            coveragesPhoneCode: [(!!walletContact.coveragesPhoneCode) ? walletContact.coveragesPhoneCode : walletContact.workspaceCountryId, [Validators.required]],
            coveragesPhoneNumber: [walletContact.coveragesPhoneNumber, [Validators.required, ValidatorsHelper.phoneNumber]],
            paymentsPhoneCode: [(!!walletContact.paymentsPhoneCode) ? walletContact.paymentsPhoneCode : walletContact.workspaceCountryId, [Validators.required]],
            paymentsPhoneNumber: [walletContact.paymentsPhoneNumber, [Validators.required, ValidatorsHelper.phoneNumber]],
            supportPhoneCode: [(!!walletContact.supportPhoneCode) ? walletContact.supportPhoneCode : walletContact.workspaceCountryId, [Validators.required]],
            supportPhoneNumber: [walletContact.supportPhoneNumber, [Validators.required, ValidatorsHelper.phoneNumber]],
            quotesPhoneCode: [(!!walletContact.quotesPhoneCode) ? walletContact.quotesPhoneCode : walletContact.workspaceCountryId, [Validators.required]],
            quotesPhoneNumber: [walletContact.quotesPhoneNumber, [Validators.required, ValidatorsHelper.phoneNumber]],
            sinistersPhoneCode: [(!!walletContact.sinistersPhoneCode) ? walletContact.sinistersPhoneCode : walletContact.workspaceCountryId, [Validators.required]],
            sinistersPhoneNumber: [walletContact.sinistersPhoneNumber, [Validators.required, ValidatorsHelper.phoneNumber]],
            coveragesPhoneCodeWhatsapp: [(!!walletContact.coveragesPhoneCodeWhatsapp) ? walletContact.coveragesPhoneCodeWhatsapp : walletContact.workspaceCountryId, [Validators.required]],
            coveragesPhoneNumberWhatsapp: [walletContact.coveragesPhoneNumberWhatsapp, [Validators.required, ValidatorsHelper.phoneNumber]],
            paymentsPhoneCodeWhatsapp: [(!!walletContact.paymentsPhoneCodeWhatsapp) ? walletContact.paymentsPhoneCodeWhatsapp : walletContact.workspaceCountryId, [Validators.required]],
            paymentsPhoneNumberWhatsapp: [walletContact.paymentsPhoneNumberWhatsapp, [Validators.required, ValidatorsHelper.phoneNumber]],
            supportPhoneCodeWhatsapp: [(!!walletContact.supportPhoneCodeWhatsapp) ? walletContact.supportPhoneCodeWhatsapp : walletContact.workspaceCountryId, [Validators.required]],
            supportPhoneNumberWhatsapp: [walletContact.supportPhoneNumberWhatsapp, [Validators.required, ValidatorsHelper.phoneNumber]],
            quotesPhoneCodeWhatsapp: [(!!walletContact.quotesPhoneCodeWhatsapp) ? walletContact.quotesPhoneCodeWhatsapp : walletContact.workspaceCountryId, [Validators.required]],
            quotesPhoneNumberWhatsapp: [walletContact.quotesPhoneNumberWhatsapp, [Validators.required, ValidatorsHelper.phoneNumber]],
            sinistersPhoneCodeWhatsapp: [(!!walletContact.sinistersPhoneCodeWhatsapp) ? walletContact.sinistersPhoneCodeWhatsapp : walletContact.workspaceCountryId, [Validators.required]],
