...
export class ShowSinisterHistoryService {
    ...
    loadSinister(sinisterData: SinisterDataSend): void {
        const fields: string = 'sinisterId,sinisterNumber,invoice,certificate,sinisterDate,sinisterStatusId,estimatedResolutionDate,manager,reportNumber,sinisterTypeName,affectedCoverage,location,affectedName';
