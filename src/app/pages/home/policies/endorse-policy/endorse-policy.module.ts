...
import { ModalUploadPolicyEndorsementModule } from '@components/modal-upload-policy-endorsement/modal-upload-policy-endorsement.module';
...
@NgModule({
  ...
  imports: [
    ...
    ModalUploadPolicyEndorsementModule,
    ReactiveFormsModule
  ],
