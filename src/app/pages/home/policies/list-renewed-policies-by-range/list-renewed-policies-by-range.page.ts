...
@Component({
  selector: 'agt-list-renewed-policies-by-range',
  templateUrl: './list-renewed-policies-by-range.page.html',
  styles: [
  ]
})
export class ListRenewedPoliciesByRangePage implements OnInit {
