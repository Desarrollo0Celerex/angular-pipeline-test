...
export class StatisticService {
    ...
    getContactPaymentStatistics(contactId: string, filters: string = '', rangeField: string = '', rangeStart: string = '', rangeEnd: string = ''): Observable<HttpResponse> {
        const route: string = routes.contactPaymentStatistics(this._workspaceId, contactId);
    ...
    getContactRenewalStatistics(contactId: string, filters: string = '', rangeField: string = '', rangeStart: string = '', rangeEnd: string = ''): Observable<HttpResponse> {
        const route: string = routes.contactRenewalStatistics(this._workspaceId, contactId);
        let params: HttpParams = new HttpParams();
        if(!!filters) params = params.append('filter', filters);
        if(!!rangeField) params = params.append('rangeField', rangeField);
        if(!!rangeStart) params = params.append('rangeStart', rangeStart);
