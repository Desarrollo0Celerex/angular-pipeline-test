...
const ROUTES = {
    workspaceUser: (workspaceId: string, userId: string) => `${environment.apiUrl}/workspaces/${workspaceId}/users/${userId}`,
    workspaceUsers: (workspaceId: string) => `${environment.apiUrl}/workspaces/${workspaceId}/users`,
    workspaceUserRole: (workspaceId: string, userId: string) => `${environment.apiUrl}/workspaces/${workspaceId}/users/${userId}/role`
}
...
export class WorkspaceUserService {
     ...
     */
    getWorkspaceUsers(fields: string = '', page: number = 1, perPage: number = 1): Observable<HttpResponse> {
     ...
     */
    updateWorkspaceUserRole(userId: string, requestBody: UpdateUserRoleDataSend): Observable<void> {
        const route: string = ROUTES.workspaceUserRole(this._workspaceId, userId);
