...
export class VoiceControlService {
    ...
    public modalNotSupported: BehaviorSubject<boolean> = new BehaviorSubject<boolean>(false);
    public modalCommandNotFound: BehaviorSubject<VoiceControlCommandNotFoundData> = new BehaviorSubject<VoiceControlCommandNotFoundData>({
        canShowModal: false,
        commandText: ''
    });
    public modalNoResults: BehaviorSubject<VoiceControlCommandNotFoundData> = new BehaviorSubject<VoiceControlCommandNotFoundData>({
        canShowModal: false,
        commandText: ''
    });
